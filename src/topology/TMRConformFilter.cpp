...
TMRConformFilter::TMRConformFilter(int _nlevels, TACSAssembler *_assembler[],
...
void TMRConformFilter::initialize(int _nlevels, TACSAssembler *_assembler[],
...
*/
MPI_Comm TMRConformFilter::getMPIComm() { return assembler[0]->getMPIComm(); }

/*
  Get the root assembler object
*/
TACSAssembler *TMRConformFilter::getAssembler() { return assembler[0]; }
...
*/
void TMRConformFilter::addValues(TACSBVec *vec) {
...
*/
void TMRConformFilter::setValues(TACSBVec *vec) {
