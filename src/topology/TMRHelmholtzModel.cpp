...
TMRQuadHelmholtzModel::TMRQuadHelmholtzModel(double _r) { r = _r; }

int TMRQuadHelmholtzModel::getNumParameters() { return 2; }

int TMRQuadHelmholtzModel::getVarsPerNode() { return 1; }

void TMRQuadHelmholtzModel::evalWeakIntegrand(
...
void TMRQuadHelmholtzModel::evalWeakMatrix(
...
TMRHexaHelmholtzModel::TMRHexaHelmholtzModel(double _r) { r = _r; }

int TMRHexaHelmholtzModel::getNumParameters() { return 3; }

int TMRHexaHelmholtzModel::getVarsPerNode() { return 1; }

void TMRHexaHelmholtzModel::evalWeakIntegrand(
    int elemIndex, const double time, int n, const double pt[],
    const TacsScalar X[], const TacsScalar Xd[], const TacsScalar Ut[],
    const TacsScalar Ux[], TacsScalar DUt[], TacsScalar DUx[]) {
  DUt[0] = Ut[0];
...
void TMRHexaHelmholtzModel::evalWeakMatrix(
    ElementMatrixType matType, int elemIndex, const double time, int n,
    const double pt[], const TacsScalar X[], const TacsScalar Xd[],
    const TacsScalar Ut[], const TacsScalar Ux[], TacsScalar DUt[],
    TacsScalar DUx[], TacsScalar Jac[]) {
