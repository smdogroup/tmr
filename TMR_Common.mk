...
TMR_CC_FLAGS = ${TMR_FLAGS} ${TMR_INCLUDE} ${TRIANGLE_INCLUDE} ${METIS_INCLUDE} ${TACS_OPT_CC_FLAGS}
TMR_DEBUG_CC_FLAGS = ${TMR_DEBUG_FLAGS} ${TMR_INCLUDE} ${TRIANGLE_INCLUDE} ${METIS_INCLUDE} ${TACS_DEBUG_CC_FLAGS}

# Set the compiler flags
TMR_LD_FLAGS = ${TMR_LD_CMD} ${TRIANGLE_LIB} ${METIS_LIB} ${TACS_LD_FLAGS}
