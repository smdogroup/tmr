...
geomLoader.nameGeometricEntities(face_names=face_names, edge_names=edge_names, writeToTecplot=True)
...
pprint(f'getLocalNodeIDsFromGlobal(): {geomLoader.getLocalNodeIDsFromGlobal(globalIDs)}')
pprint(f'getGlobalToLocalElemIDDict(): {geomLoader.getGlobalToLocalElemIDDict()}')
pprint(f'getLocalElementIDsFromGlobal(): {geomLoader.getLocalElementIDsFromGlobal(globalIDs)}')
...
pprint(f'getLocalElementIDsForComps(): {geomLoader.getLocalElementIDsForComps(compIDs)}')
pprint(f'getGlobalElementIDsForComps(): {geomLoader.getGlobalElementIDsForComps(compIDs)}')