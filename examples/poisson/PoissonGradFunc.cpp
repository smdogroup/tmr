...
TACSPoissonGradFunction::TACSPoissonGradFunction( TACSAssembler *_tacs,
...
*/
const char *TACSPoissonGradFunction::functionName(){
  return funcName;
}
...
*/
void TACSPoissonGradFunction::setGradFunctionType( PoissonGradFunctionType _ksType ){
  ksType = _ksType;
}
...
void TACSPoissonGradFunction::initThread( double tcoef,
...
void TACSPoissonGradFunction::elementWiseEval( EvaluationType ftype,
...
void TACSPoissonGradFunction::finalThread( double tcoef, 
                                           EvaluationType ftype,
                                           TACSFunctionCtx *fctx ){
  PoissonGradFuncCtx *ctx = dynamic_cast<PoissonGradFuncCtx*>(fctx);
  if (ctx){
...
void TACSPoissonGradFunction::getElementSVSens( double alpha, double beta, double gamma, 
