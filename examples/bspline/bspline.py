...
p1 = TMR.BsplinePcurve(np.array([[0.1, 0.0], [0.4, 0.0]]))
p2 = TMR.BsplinePcurve(np.array([[0.4, 0.0], [0.4, 1.0]]))
p3 = TMR.BsplinePcurve(np.array([[0.4, 1.0], [0.1, 1.0]]))
p4 = TMR.BsplinePcurve(np.array([[0.1, 1.0], [0.1, 0.0]]))
